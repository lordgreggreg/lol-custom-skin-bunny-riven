...
//Name: bunnyEars.ma
//Last modified: Mon, Dec 26, 2011 02:24:48 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.3390291863780921 152.84861691006125 10.078543150743387 ;
	setAttr ".r" -type "double3" -20.738352729675718 5.7999999999239416 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 23.344855976915305;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polyMergeVert41.out" "polySurfaceShape6.i";

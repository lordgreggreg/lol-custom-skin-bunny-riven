...
//Name: bunnyEars.ma
//Last modified: Mon, Dec 26, 2011 01:40:46 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.8428496398812584 142.62765262978655 4.4584396297703393 ;
	setAttr ".r" -type "double3" 8.6616472703933898 26.200000000000667 -4.430934819000295e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.393188818449268;
...
createNode mesh -n "polySurfaceShape6" -p "polySurface6";
	...
	setAttr -s 4 ".pt";
	setAttr ".pt[27]" -type "float3" -0.098946467 0.097695619 -0.11572123 ;
	setAttr ".pt[32]" -type "float3" 0.028223157 0.033311091 -0.067751601 ;
	setAttr ".pt[102:103]" -type "float3" -0.36295444 0.3672491 -0.076551221  
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polySplit2.out" "polySurfaceShape6.i";

...
//Name: bunnyEars.ma
//Last modified: Mon, Dec 26, 2011 01:38:25 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.4052766838682551 144.50320324978094 -19.793402947716064 ;
	setAttr ".r" -type "double3" -0.33835272961143437 -218.60000000003438 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 8.3339183906702239;
...
createNode mesh -n "polySurfaceShape6" -p "polySurface6";
	...
	setAttr ".pt[29]" -type "float3"  0.62010074 -0.29000282 -0.20376711;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polyMergeVert20.out" "polySurfaceShape6.i";

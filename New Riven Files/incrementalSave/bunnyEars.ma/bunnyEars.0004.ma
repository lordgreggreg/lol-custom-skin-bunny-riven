...
//Name: bunnyEars.ma
//Last modified: Mon, Dec 26, 2011 01:47:34 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.329619536187638 142.32345849214212 -18.380480062245496 ;
	setAttr ".r" -type "double3" 7.4616472703122563 112.99999999994721 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.39318881844428;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "polySplit9.out" "polySurfaceShape6.i";
